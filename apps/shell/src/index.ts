...
// Load remote microfrontend components so their custom elements get registered
Promise.all([
  import('marketOverview/MarketOverview'),
  import('watchlist/WatchlistPanel'),
  import('assetDetails/AssetDetails'),
  import('tradeStream/TradeStream'),
